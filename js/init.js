...
function updateCopyright(){
	...
	var copyContainer = document.getElementById('copyright-period');

	var copyPeriod = "2019";
	var currentYear = new Date().getFullYear();
	
	if (currentYear != 2019) {
		copyPeriod += "-" + currentYear;
		copyContainer.innerHTML = copyPeriod;
	}
...
function arlo_tm_animate_text(){
	...
	var animateSpan			= jQuery('.arlo_tm_animation_text_word');
		...
		animateSpan.typed({
			strings: ["I'm a Developer", "I'm an Engineer", "I'm an Explorer"],
			loop: true,
			startDelay: 1e3,
			backDelay: 2e3
		});
